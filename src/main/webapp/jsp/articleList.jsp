            ...
            <div class="ui inverted stackable menu">
                <div id="article_list_container" class="ui inverted secondary  menu">
                    ...
                    <div class="ui inverted secondary  menu">
                        ...
                        <a id="article_update_btn" href="javascript:void(0);" class="m-item item m-mobile-hide" target="_blank"><i class="teal tags icon"></i>修改博客</a>
                        <%--<a id="article_delete_btn" href="javascript:void(0);" class="m-item item m-mobile-hide" ><i class="teal clone icon"></i>删除</a>--%>
						<a id="article_delete_btn" href="jsp/articleDelete.jsp?userAccout=stu&type=add" class="m-item item m-mobile-hide"  target="_blank"><i class="teal clone icon"></i>删除文章列表</a>
